@extends('theme.platform-baijiahao-20260725.layout')
...
@section('content')
    ...
    <div class="pf-shell pf-home-grid">
        @include('theme.platform-baijiahao-20260725.partials.channel-rail')
                ...
                <section class="pf-feed-section pf-featured-section">
                    ...
                    <div class="pf-feed-list">
                        @foreach($featuredArticles->take(3) as $article)
                            @include('theme.platform-baijiahao-20260725.partials.article-card', ['article' => $article, 'showFeaturedBadge' => true])
                        @endforeach
                    </div>
                </section>
            @endif
            ...
            <section class="pf-feed-section">
                ...
                <div class="pf-feed-list">
                    @forelse($articles as $article)
                        @include('theme.platform-baijiahao-20260725.partials.article-card', ['article' => $article])
                    @empty
        ...
        @include('theme.platform-baijiahao-20260725.partials.sidebar', ['showFeedPanel' => $isDefaultHome])
    </div>
@endsection
