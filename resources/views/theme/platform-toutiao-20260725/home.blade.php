...
@section('content')
    ...
    <div class="pf-shell pf-home-grid">
                ...
                <section class="pf-feed-section pf-featured-section">
                    ...
                    <div class="pf-feed-list">
                        @foreach($featuredArticles->take(3) as $article)
                            @include('theme.platform-toutiao-20260725.partials.article-card', ['article' => $article, 'showFeaturedBadge' => true])
                        @endforeach
                    </div>
                </section>
            @endif
        ...
        @include('theme.platform-toutiao-20260725.partials.sidebar', ['showFeedPanel' => $isDefaultHome])
    </div>
@endsection
