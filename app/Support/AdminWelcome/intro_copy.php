...
return [
    'zh-CN' => [
        ...
        'letter' => [
            'title' => '写给点签GEO使用者的一封信',
            'subtitle' => '点签GEO是一套面向 AI 搜索与多站点分发的智能内容中台。它不承诺排名，而是用真实资料、结构化内容和持续验证，提高被理解、引用和推荐的概率。',
            'blocks' => [
                [
                    'type' => 'paragraph',
                    'content' => '你好，欢迎使用点签GEO。这个系统的出发点不是把内容生产变成一次性的批量生成，而是把资料、事实、提示词、审核、发布、分发和数据复盘连接成一个可持续的 GEO 工作流。',
                ],
                [
                    'type' => 'paragraph',
